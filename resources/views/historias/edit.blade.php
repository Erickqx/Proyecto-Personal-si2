...
<div class="card">
    <div class="card-body">
            <form action="{{route('historias.update', $historialclin)}}" method="post"  >
                @csrf
                @method('put')
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                       ...
                       <input type="text" name="descripcion" class="form-control"  value="{{$historialclin->descripcion}}" id="nombre" required>


                       <label for="nombre">Ingresar Ocupacion</label>
                       <input type="text" name="ocupacion" class="form-control"  value="{{$historialclin->ocupacion}}" id="nombre" required>

                       <label for="nombre">Ingresar El Motivo De La Consulta</label>
                       <input type="text" name="ultimaconsulta" class="form-control"  value="{{$historialclin->ultimaconsulta}}" id="nombre" required>
                   ...
                   <h2>Antecedente Patologico</h2>
                       ...
                       <input type="text" name="otros" class="form-control"  value="{{$antenopat->otros}}" id="otros" required>
                ...
                <a class="btn btn-primary btn-sm" href="{{route('historias.index')}}">Volver</a>
            </form> 
